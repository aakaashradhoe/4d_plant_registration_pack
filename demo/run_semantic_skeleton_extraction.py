...
from plant_registration import somSkeleton as som
from plant_registration import utils
import os
...
species = 'maize'
day = '03-13'
model_path = path_file + '/models/{}_svm.joblib'

# loading point cloud and downsample
path = path_file+ '/data/{}/{}.ply'
...
# perform clustering
dbscan = DBSCAN(min_samples=2, p=1).fit(leaf[:, :-1])
